...
<body id="LoginForm">
  ...
  <!-- Brand -->
  <a class="navbar-brand" href="index.html">컴수알</a>
...
%>
    ...
    <li class="nav-item">
     ...
     <li class="nav-item">
      <a class="nav-link" href="carasel.html">학년별 수업</a>
    </li>
       <li class="nav-item">
      <a class="nav-link" href="review.html">수강생 후기</a>
    </li>
...
<div class="main-div">
    <div class="panel">
   <h1 style="font-family:'Jua' ">회원가입</h1>
   <p style="font-family:'Jua' ">회원님의 정보를 입력해주세요</p>
   </div>
